...
Merger::Ptr Merger::create(const QString& videoFilePath
...
Merger::Merger(const QString& videoFilePath
               , const QString& reversedVideoFilePath
               , const QString& mergedFilePath
               , const unsigned loopCount) : Runnable("Merger", "d:/Tools/ffmpeg/ffmpeg.exe", {})
{
